...
public class Menu {
    ...
    func menuInit() {
        ...
        endGameView = UIView(frame: CGRect(x: 0, y: 0, width: 180, height: 320))
        ...
        rankPicture.center = CGPoint(x: endGameView.frame.width/2, y: 100)
...
//        rankPicture.image = UIImage(CGImage: image)
        ...
        scoreNumber.frame.origin.y = 230
        ...
        endGameViewButton!.frame.origin.y = 280
